                            ...
                            <div className="w-full p-4 px-5 py-5">
                                <div className="md:grid md:grid-cols-3 gap-2 ">
                                    <div className="col-span-2 p-5">
                                        ...
                                        {isEmpty ? <div className="flex justify-center items-center mt-6 pt-6 border-t"> <span className="text-md  font-medium text-black">Your cart is empty</span></div> : null}
                                        {items.map((item) => {
                                            return(
                                        <div key={item.id} className="flex justify-between items-center mt-6 pt-6">
                                            ...
                                            <div className="flex justify-center items-center">
                                                ...
                                                <button onClick={()=>updateItemQuantity(item.id,item.quantity-1)} className="font-semibold">-</button>
                                    ...
                                    <div className=" p-5 bg-gray-800 rounded overflow-visible">
                                        ...
                                        <div className="overflow-visible flex justify-between items-center mt-2">
                                            ...
                                            <div className="flex justify-center  items-center flex-col">
                                                <img alt="mastercard" src="https://img.icons8.com/color/96/000000/mastercard-logo.png" width={40} className="relative right-5" />
